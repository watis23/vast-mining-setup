...
#!/bin/bash
cd ~/SRBMiner-Multi
./SRBMiner-MULTI --algorithm sha3x --gpu --pool tari.luckypool.io:6118 --wallet solo:12ir17cJTQkjRGVAbrAWC61jHMCLym9w3RyrRHaK4aopzMEybXitHKDemQJ47V8xLFbbLmPrvxYiuyTGcktCntsGyG --password x
