...
#!/bin/bash
cd ~/SRBMiner-Multi
./SRBMiner-MULTI --algorithm cryptixhash --gpu --pool cytx.gogpool.eu:46101 --wallet cryptix:qrq59r8pa48dm4a3vjwqnrq2y5squwu2agkcp9vzypq0ngd9hp24w5exahhxh --password vastworker01
