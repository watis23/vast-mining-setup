...
#!/bin/bash
cd ~/SRBMiner-Multi
./SRBMiner-MULTI --disable-cpu --algorithm progpow_zano --pool stratum+tcp://evox.dogejones.com:52600 --wallet solo:iE2nZCT5o4cHuGPHJErnqohRowC5cAeTQQVrcxqcDCZjHSdJ172VhMrhZrdWdpQRsrCb66vH8oAuk72ttFJecytxdKzgi2MjGHb2Cbd2s --password x
