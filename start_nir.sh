...
#!/bin/bash
cd ~/SRBMiner-Multi
./SRBMiner-MULTI --algorithm progpow_zano --gpu --pool nirmata.luckypool.io:3366 --wallet iN3XhrBECkEYtsreTmm99L98jzfETG1krVWwQMfSnG7QXev3qhPLRUENXkAMKFP8jjbsuVPr45hN16EaP3HPse6hLSjiPe8uL8V2v6duu --password x
